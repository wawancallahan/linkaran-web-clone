...
import { FormField, ServiceEditField, ServiceEditResult } from '../../../../../types/admin/service';
    ...
    return (
        <Formik 
            ...
            onSubmit={(values, action) => {
                ...
                const servicePrice: ServiceEditField = {
                    name: values.name,
                    code: values.code,
                ...
                swal("Apakah anda yakin?", "Data akan diubah!", {
                    ...
                    if (willEdited) {
                        props.editServiceAction(servicePrice, props.id)
