...
import { FormField, BankEditField, BankEditResult } from '../../../../../types/admin/bank';
...
type LinkDispatchToProps = {
    editBankAction: (bank: BankEditField, id: number) => Promise<ApiResponse<BankEditResult>>
    setAlertBankShowAction: (message: string, color: string) => void
}

const mapDispatchToProps = (dispatch: ThunkDispatch<any, any, AppActions>, OwnProps: OwnProps): LinkDispatchToProps => {
    return {
        editBankAction: (bank: BankEditField, id: number) => dispatch(editBankAction(bank, id)),
