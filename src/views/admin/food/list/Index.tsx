...
import { fetchFoodAction, setAlertFoodHideAction, clearFilterAction } from '../../../../actions/admin/food';
...
const Index: React.FC<Props> = (props) => {
    ...
    const fetch = async (page: number) => {
        ...
        await props.fetchFoodAction(page);
