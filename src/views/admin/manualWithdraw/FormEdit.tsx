...
import { ManualWithDraw, FormField, ManualWithDrawEditField, ManualWithDrawEditResult } from '../../../types/admin/manualWithdraw';
            ...
            <Formik 
                ...
                onSubmit={(values, action) => {
                    ...
                    swal("Apakah anda yakin?", "Data akan diubah!", {
                        ...
                        if (willEdited) {
                            this.props.editManualWithDrawAction(manualWithdraw, this.props.id)
                                .then( (response: ApiResponse<ManualWithDrawEditResult>) => {
                                    ...
                                    this.props.setAlertManualWithDrawShowAction('Data Berhasil Diedit', 'success');
