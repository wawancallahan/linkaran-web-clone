...
import { FormField, DriverCreateField, DriverCreateResult } from '../../../../../../types/admin/driver';
import { createDriverAction, setAlertDriverShowAction } from '../../../../../../actions/admin/driver';
...
type LinkDispatchToProps = {
    createDriverAction: (driver:DriverCreateField) => Promise<ApiResponse<DriverCreateResult>>
    setAlertDriverShowAction: (message: string, color: string) => void
}

const mapDispatchToProps = (dispatch: ThunkDispatch<any, any, AppActions>, OwnProps: OwnProps): LinkDispatchToProps => {
    return {
        createDriverAction: (driver:DriverCreateField) => dispatch(createDriverAction(driver)),
