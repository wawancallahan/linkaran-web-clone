...
import { Partner, FormField, PartnerEditField, PartnerEditResult } from '../../../types/admin/partner';
import { editPartnerAction, setAlertPartnerShowAction } from '../../../actions/admin/partner';
        ...
        return (
            <Formik 
                ...
                onSubmit={(values, action) => {
                    ...
                    const partner: PartnerEditField = {
                        name: values.name,
                        email: values.email,
                    ...
                    swal("Apakah anda yakin?", "Data akan diubah!", {
                        ...
                        if (willEdited) {
                            this.props.editPartnerAction(partner, this.props.id)
                                .then( (response: ApiResponse<PartnerEditResult>) => {
                                    const data: ApiResponseSuccess<PartnerEditResult> = response.response!;
                                    this.props.setAlertPartnerShowAction('Data Berhasil Diedit', 'success');
                                    this.props.redirectOnSuccess();
                                })
                                .catch( (error: ApiResponse<PartnerEditResult>) => {
...
type LinkDispatchToProps = {
    editPartnerAction: (partner: PartnerEditField, id: number) => Promise<ApiResponse<PartnerEditResult>>
    setAlertPartnerShowAction: (message: string, color: string) => void
}

const mapDispatchToProps = (dispatch: ThunkDispatch<any, any, AppActions>, OwnProps: FormProps): LinkDispatchToProps => {
    return {
        editPartnerAction: (partner: PartnerEditField, id: number) => dispatch(editPartnerAction(partner, id)),
