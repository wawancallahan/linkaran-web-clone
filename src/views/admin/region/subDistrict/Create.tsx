...
import { SubDistrict, FormField } from '../../../../types/admin/region/subDistrict';

import FormSubDistrict from './Form';
                    ...
                    <Card className="bg-secondary shadow">
                        <CardHeader className="bg-white border-0">
                            <Row className="align-items-center">
                                <Col>
                                    <h3 className="mb-0">Tambah Sub District</h3>
                                </Col>
                            </Row>
                        </CardHeader>
                        <CardBody>
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(
        withTitle(Create, "Tambah Sub District")
    )
);