...
import { Province, FormField } from '../../../../types/admin/region/province';

import FormProvince from './Form';
                    ...
                    <Card className="bg-secondary shadow">
                        <CardHeader className="bg-white border-0">
                            <Row className="align-items-center">
                                <Col>
                                    <h3 className="mb-0">Tambah Province</h3>
                                </Col>
                            </Row>
                        </CardHeader>
                        <CardBody>
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(
        withTitle(Create, "Tambah Province")
    )
);