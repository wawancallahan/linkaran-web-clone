...
import { District, FormField } from '../../../../types/admin/region/district';

import FormDistrict from './Form';
                    ...
                    <Card className="bg-secondary shadow">
                        <CardHeader className="bg-white border-0">
                            <Row className="align-items-center">
                                <Col>
                                    <h3 className="mb-0">Tambah Kabupaten/ Kota</h3>
                                </Col>
                            </Row>
                        </CardHeader>
                        <CardBody>
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(
        withTitle(Create, "Tambah Kabupaten/ Kota")
    )
);