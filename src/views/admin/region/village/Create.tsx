...
import { Village, FormField } from '../../../../types/admin/region/village';

import FormVillage from './Form';
                    ...
                    <Card className="bg-secondary shadow">
                        <CardHeader className="bg-white border-0">
                            <Row className="align-items-center">
                                <Col>
                                    <h3 className="mb-0">Tambah Kelurahan</h3>
                                </Col>
                            </Row>
                        </CardHeader>
                        <CardBody>
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(
        withTitle(Create, "Tambah Kelurahan")
    )
);