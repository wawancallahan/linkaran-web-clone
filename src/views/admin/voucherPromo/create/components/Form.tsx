...
import { FormField, VoucherPromoCreateField, VoucherPromoCreateResult } from '../../../../../types/admin/voucherPromo';
        ...
        <Formik 
            ...
            onSubmit={(values, action) => {
                ...
                swal("Apakah anda yakin?", "Data akan ditambahkan!", {
                    ...
                    if (willCreated) {
                        props.createVoucherPromoAction(voucherPromo)
                            .then( (response: ApiResponse<VoucherPromoCreateResult>) => {
                                ...
                                props.setAlertVoucherPromoShowAction('Data Berhasil Ditambah', 'success');
