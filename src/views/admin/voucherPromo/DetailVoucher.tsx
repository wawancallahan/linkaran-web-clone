...
import { Row, Col, Card, CardHeader, CardBody, Progress, Badge } from 'reactstrap'
...
type Props = DetailVoucherProps

class DetailVoucher extends Component<Props> {
    render () {

        const { voucher, ticketState, voucherState } = this.props;

        if (voucher) {

            let buttonLinkState = null;

            if (ticketState && ! voucherState) {
                buttonLinkState = (
                    <>
                        <div className="mb-2">
                            <Link to={`/admin/voucher-promo/${voucher.id}`} className="btn btn-info btn-sm">
            ...
            if ( ! ticketState && voucherState) {
                buttonLinkState = (
                    <>
                        <div className="mb-2">
                            <Link to={`/admin/voucher-promo/ticket/${voucher.id}`} className="btn btn-info btn-sm">
            ...
            if (voucher.image) imageBrand = voucher.image
                                ...
                                <Col md={8} xs={12}>
                                    <div className="d-flex">
                                        <div className="mr-auto">
                                            <div>
                                                <div style={{
                                                    fontSize: '18px',
                                                    lineHeight: '20px'
                                                }} className="mb-1">{voucher.name}</div>
                                                <div style={{
                                                    fontSize: '15px',
                                                    lineHeight: '18px'
                                                }} className="mb-2">{voucher.code}</div>
                                                <div className="mb-2">
                                                ...
                                                <div className="mb-1" style={{
                                                    ...
                                                    Minimum Pembelian Rp. {voucher.minimumPurchase}
                                                </div>
                                                <div className="mb-1" style={{
                                                    fontSize: '13px',
                                                    lineHeight: '15px'
                                                }}>
                                                    Target Pegunaan {voucher.isLimited ? 'Terbatas' : 'Publik'}
                                                </div>
                                                <div className="mb-1" style={{
                                                    fontSize: '13px',
                                                    lineHeight: '15px'
                                        ...
                                        <div className="ml-auto">
                                            <div className="mb-4">
                                                <Badge color="success">{voucherUsedFormat(voucher.startDateTime, voucher.endDateTime)}</Badge>
                                            </div>
                                            <div className="mb-4">
                                                <div>
                                                    <div className="d-inline-block mr-2">
                                                    ...
                                                    <div className="d-inline-block">
                                                        {parseDateTimeFormat(voucher.startDateTime)}
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="d-inline-block">
                                                        {parseDateTimeFormat(voucher.endDateTime)}
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
