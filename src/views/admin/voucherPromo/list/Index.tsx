...
import { fetchVoucherPromoAction, setAlertVoucherPromoHideAction, clearFilterAction } from '../../../../actions/admin/voucherPromo';
...
const Index: React.FC<Props> = (props) => {
    ...
    const fetch = async (page: number) => {
        ...
        await props.fetchVoucherPromoAction(page);
    ...
    React.useEffect(() => {
        ...
        return () => {
            props.setAlertVoucherPromoHideAction();
                        ...
                        <Card className="shadow">
                            <CardHeader className="border-0">
                                ...
                                <Row className="align-items-center mb-3">
                                    <div className="col">
                                        <h3 className="mb-0">Daftar Voucher</h3>
                                    </div>
                                    <div className="col text-right">
                                        <a href="/admin/voucher-promo/create">
                                            <Button
                                                color="primary"
                                                size="sm"
                                            >
