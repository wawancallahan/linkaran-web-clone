...
import { FormField, InvestorEditField, InvestorEditResult } from '../../../../../types/admin/investor';
import { editInvestorAction, setAlertInvestorShowAction } from '../../../../../actions/admin/investor';
        ...
        <Formik 
            ...
            onSubmit={(values, action) => {
                ...
                swal("Apakah anda yakin?", "Data akan diubah!", {
                    ...
                    if (willEdited) {
                        props.editInvestorAction(investor, props.id)
                            .then( (response: ApiResponse<InvestorEditResult>) => {
                                const data: ApiResponseSuccess<InvestorEditResult> = response.response!;
                                props.setAlertInvestorShowAction('Data Berhasil Diedit', 'success');
