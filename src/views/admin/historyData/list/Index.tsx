...
import { fetchHistoryDataAction, setAlertHistoryDataHideAction, clearFilterAction } from '../../../../actions/admin/historyData';
...
const Index: React.FC<Props> = (props) => {
    ...
    const fetch = async (page: number) => {
        ...
        await props.fetchHistoryDataAction(page);
    ...
    React.useEffect(() => {
        ...
        return () => {
            props.setAlertHistoryDataHideAction();
                        ...
                        <Card className="shadow">
                            <CardHeader className="border-0">
                                ...
                                <Row className="align-items-center mb-3">
                                    <div className="col">
                                        <h3 className="mb-0">Daftar Histori Data</h3>
                                    </div>
                                </Row>
                                <Filter />
                            </CardHeader>
