...
class Index extends React.Component<Props, State> {
    ...
    getIconOrder = (service: any, vehicleType: any, maxRadius: any, minRadius: any, maxDriverDistanceRadius: any) => {
        let serviceCode;
        ...
        return {
            ...
            url: `https://linkaran.demo.thortech.asia/api/icon/req/${MaxRad}-${MBRad}/${serviceCode}.svg`,
        };
      }
    ...
    componentDidUpdate() {
        if (this.state.mapIsReady) {
            ...
            const socket = io('https://linkaran.demo.thortech.asia/admin', {
                path: '/ws/socket.io',
                ...
                socket.on('driver-location', (response: any) => {
                    if (['new', 'update'].find(it => it === response.event)) {
                        ...
                        const icon = {
                            ...
                            origin: new google.maps.Point(0, 0),
                            url: `https://linkaran.demo.thortech.asia/api/icon/${vt}/${status}.svg`,
                        };
