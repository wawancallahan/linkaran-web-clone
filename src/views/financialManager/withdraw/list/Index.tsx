...
import { fetchWithDrawAction, setAlertWithDrawHideAction, clearFilterAction } from '../../../../actions/financialManager/withdraw';
...
const Index: React.FC<Props> = (props) => {
    ...
    const fetch = async (page: number) => {
        ...
        await props.fetchWithDrawAction(page);
    ...
    React.useEffect(() => {
        ...
        return () => {
            props.setAlertWithDrawHideAction();
                        ...
                        <Card className="shadow">
                            <CardHeader className="border-0">
                                ...
                                <Row className="align-items-center mb-3">
                                    <div className="col">
                                        <h3 className="mb-0">Daftar Penarikan</h3>
                                    </div>
                                </Row>
                                <Filter />
                            </CardHeader>
