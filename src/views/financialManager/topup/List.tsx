...
const TableItem = (props: {
    ...
    return (
        <tr>
            <td>{props.index + 1}</td>
            <td>{(props.item.request.driverProfile && props.item.request.driverProfile.user) ? props.item.request.driverProfile.user.name : ''}</td>
            <td>{(props.item.request.driverProfile && props.item.request.driverProfile.user) ? props.item.request.driverProfile.user.phoneNumber : ''}</td>
            <td>{(props.item.request.driverProfile && props.item.request.driverProfile.user) ? props.item.request.driverProfile.user.email : ''}</td>
            <td>{props.item.request.bankName}/{props.item.request.accountNumber}</td>
            <td>{props.item.request.accountName}</td>
            <td>{props.item.request.uniqueCodeWithAmount}</td>
            <td>{props.item.request.bank ? props.item.request.bank.accountName : ''}</td>
