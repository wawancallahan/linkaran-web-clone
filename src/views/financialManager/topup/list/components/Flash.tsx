...
import { setAlertTopUpHideAction } from '../../../../../actions/financialManager/topup';
...
const Flash: React.FC<Props> = (props) => {
    return (
        <Alert color={props.alert.color} isOpen={props.alert.visible} toggle={() => props.setAlertTopUpHideAction()} fade={false}>
